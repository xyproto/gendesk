...
---------------------------
* Flags overrides the values from a given PKGBUILD file.
* Switch a dependency from `akrennmair/gconf` to `unknwon/goconf`.
* Switch a dependency from `xyproto/term` to `xyproto/textoutput`.

Changes from 1.0.1 to 1.0.2
---------------------------
* Specify version `1.0` in generated `.desktop` files, instead of version `1.2`.
