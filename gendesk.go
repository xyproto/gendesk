...
func writeWindowManagerDesktopFile(pkgname, name, exec, custom string, force bool, o *TextOutput) {
...
func writeDesktopFile(pkgname string, name string, comment string, exec string,
	useTerminal bool, categories string, genericName string, mimeTypes string, startupNotify bool, custom string, force bool, o *TextOutput) {
...
func WriteDefaultIconFile(pkgname string, o *TextOutput) error {
...
func main() {
	...
	flag.Usage = func() {
		...
		fmt.Println("      the PKGBUILD, an icon will be downloaded from either the")
		fmt.Println("      download location specified in the configuration or from:")
