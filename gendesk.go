...
const (
	version_string = "Desktop File Generator v.0.6"
)
...
func writeDesktopFile(pkgname string, name string, comment string, exec string,
	useTerminal bool, categories string, genericName string, mimeTypes string, custom string, force bool, o *Output) {
...
func main() {
	...
	for _, pkgname := range pkgnames {
		...
		// TODO: Find a better way than all the if checks below
		...
		if *windowmanager {
			...
			writeDesktopFile(pkgname, name, comment, exec, *terminal, categories, genericName, mimeTypes, custom, *force, o)
		}
